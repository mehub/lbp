...
<!-- 	<meta http-equiv="x-ua-compatible" content="ie=7" /> -->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#ownerAscId_ac').simpleAutoComplete(path+"/mds/org/autoCompleteMoreOrg.action?typeId=000001395018",
				{
					hiddenElement : {
						ownerAscId : 'id'
					}
...
<body>
<s:form id="updateForm" action="updateFranchiseOrg.action" method="post" onsubmit="return ajaxCallback(this)">
	<s:hidden name="id"/>
