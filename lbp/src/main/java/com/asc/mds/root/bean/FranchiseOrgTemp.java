 ...
 * 类描述 .
 * @author chenzhenling
 * @version 版本信息 创建时间 2012-12-13 下午3:24:56
 */
@Entity
@Table(name = "MD_FRANCHISE_ORG_TEMP")
public class FranchiseOrgTemp {
	...
	@Id
	@GeneratedValue(generator = "MdFranchiseOrgTempGenerator")
	@GenericGenerator(name = "MdFranchiseOrgTempGenerator", strategy = "com.asc.common.StringSequenceGenerator")
	public String getId(){
		return this.id;
	}
