 ...
 * 类描述 .
 * @author chenzhenling
 * @version 版本信息 创建时间 2012-12-13 下午3:25:12
 */
@Entity
@Table(name = "MD_ORG_PRODUCT_TEMP")
public class OrgProductTemp {
	...
	@Id
	@GeneratedValue(generator = "MdOrgProductTempGenerator")
	@GenericGenerator(name = "MdOrgProductTempGenerator", strategy = "com.asc.common.StringSequenceGenerator")
	public String getId(){
		return this.id;
	}
